function runTrainerInstancing(playerName) {
    ...
    trainer1 = new npcTrainer('Joel', pokemon1, pokemon2, null, null, null, null, 100, 'Liker du fisk?', 'Hold i torsken!', 'Fisk er sunt!', 'img/trainers/joel.png');
    trainer2 = new npcTrainer('Romero', pokemon4, null, null, null, null, null, 100, 'Lykke til!', 'Bedre lykke nestegang!', 'Wow... Du er flink...', 'img/trainers/romero.png');
